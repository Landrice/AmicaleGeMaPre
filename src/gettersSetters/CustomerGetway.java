...
public class CustomerGetway {
    ...
    public void view(Customer customer, String sigle) {
        con = dbCon.geConnection();
        try {
            ...
            while (rs.next()) {
                ...
                customer.userName = sql.getNameR(customer.userId, customer.userName, "Utilisateur",sigle);
    ...
    public void searchView(Customer customer,String sigle) {
        con = dbCon.geConnection();
