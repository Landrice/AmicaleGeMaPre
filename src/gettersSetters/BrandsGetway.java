...
public class BrandsGetway {
    ...
    public void view(Brands brands, String sigle) {
        con = dbCon.geConnection();
        ...
        try {
            ...
            while (rs.next()) {
                ...
                brands.supplyerName = sql.getNameR(brands.supplyrId, brands.supplyerName, "fournisseur",sigle);
                brands.creatorName = sql.getNameR(brands.creatorId, brands.creatorName, ""+sigle+"_utilisateur",sigle);
    ...
    public void selectedView(Brands brands, String sigle) {
        con = dbCon.geConnection();
    ...
    public void searchView(Brands brands, String sigle) {
        con = dbCon.geConnection();
