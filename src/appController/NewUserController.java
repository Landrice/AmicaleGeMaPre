...
public class NewUserController implements Initializable {
    ...
    @FXML
    private JFXPasswordField pfReUserPassword;
    @FXML
    ...
    private void hlLogin(ActionEvent event) throws IOException {
        ...
        nStage.setTitle("Nouveau Utlisateur");
    ...
    private boolean passMatch() {
        ...
        if (password.matches(rePass)) {
            ...
            a.setTitle("Erreur");
            a.setHeaderText("Mot de passe incorrecte");
            a.setContentText("Les mots de passes sont differents,\nVeuillez ressayer");
            a.showAndWait();
        }
        return passMatch;
