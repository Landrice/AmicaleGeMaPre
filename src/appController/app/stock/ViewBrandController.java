...
public class ViewBrandController implements Initializable {
    ...
    private void tfSearchOnKeyPress(KeyEvent event) {
        ...
        if (ml.isSelected() == true) {
            brandsGetway.searchView(brands, "ml");
        } else if (gl.isSelected() == true) {
            brandsGetway.searchView(brands, "bl");
        } else if (pt.isSelected() == true) {
            brandsGetway.searchView(brands, "pt");
        } else if (pz.isSelected() == true) {
            brandsGetway.searchView(brands, "pz");
    ...
    public void showDetails() {
        ...
        if (ml.isSelected() == true) {
            brandsGetway.view(brands, "dml");
        } else if (gl.isSelected() == true) {
            brandsGetway.view(brands, "dbl");
        } else if (pt.isSelected() == true) {
            brandsGetway.view(brands, "dpt");
        } else if (pz.isSelected() == true) {
            brandsGetway.view(brands, "dpz");
        } else if (bl.isSelected() == true) {
            brandsGetway.view(brands, "dbl");
        } else {
            System.out.println("Aucune dépot n'est selectionné");
    ...
    private void viewDetails() {
        ...
        if (!items.equals(null)) {
            ...
            try {
                ...
                if (ml.isSelected() == true) {
                    addBrandController.ml.setSelected(true);
                } else if (gl.isSelected() == true) {
                    addBrandController.gl.setSelected(true);
                } else if (pt.isSelected() == true) {
                    addBrandController.pt.setSelected(true);
                } else if (pz.isSelected() == true) {
                    addBrandController.pz.setSelected(true);
                } else if (bl.isSelected() == true) {
                    addBrandController.bl.setSelected(true);
                } else {
                    System.out.println("Aucune dépot n'est selectionné");
                }
                media.setId(usrId);
