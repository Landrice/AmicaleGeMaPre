...
import appController.app.employe.AddEmployeeController;
import appController.app.employe.ViewEmployeController;
...
public class EmployeController implements Initializable {
    ...
    private void btnAddEmployeeOnClick(ActionEvent event) throws IOException {
        ...
        fXMLLoader.load(getClass().getResource("/app/app/employe/AddEmployee.fxml").openStream());
        media.setId(userId);
...
//        addEmployeController.showDetails();
    ...
    public void btnViewEmployeeOnAction(ActionEvent event) throws IOException {
        ...
        FXMLLoader fXMLLoader = new FXMLLoader();
        fXMLLoader.load(getClass().getResource("/app/app/employe/ViewEmploye.fxml").openStream());
        media.setId(userId);
